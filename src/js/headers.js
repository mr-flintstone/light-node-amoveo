...
function headers_main() {
  //   var mode = "production";
    ...
    //var button = button_maker2("more 2 headers ", more_headers);
    //document.body.appendChild(button);
    wallet_text = document.createElement("p");
//    wallet_text.innerHTML = JSON.stringify([["height", 0], ["total work", 0]]);

    wallet_text.innerHTML = "sync in progress";
    wallet_text.style.fontStyle = "italic";
    //JSON.stringify([["height", 0], ["total work", 0]]);


    document.body.appendChild(wallet_text);
//    document.body.appendChild(headers_button);

//
//    price_text = document.createElement("p");
//    price_text.innerHTML = "loading price"
//    price_text.style.fontStyle = "italic";
//    document.body.appendChild(price_text);


  //  function loadPrice(){
  //    var request20 = new XMLHttpRequest();
  //    request20.open('GET', 'https://api.qtrade.io/v1/orderbook/[BTC_VEO]', true);
...
//        console.log(data);
  ...
  //      }
    ...
    var headers_button = button_maker2("Update headers", function() { })
    var t = document.createTextNode("Update headers");       // Create a text node
    headers_button.appendChild(t);
    headers_button.onclick = function() { more_headers() };
